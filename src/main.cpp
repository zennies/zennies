...
#if defined(NDEBUG)
# error "ZeniCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "ZeniCoin Signed Message:\n";
...
#ifdef ENABLE_WALLET
// ZeniCoin: attempt to generate suitable proof-of-stake
